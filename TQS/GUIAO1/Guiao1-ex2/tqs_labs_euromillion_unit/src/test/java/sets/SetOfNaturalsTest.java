...
public class SetOfNaturalsTest {
    ...
    // Testes que foram adicionados

        // gerar exepção  ao tentar adicionar um valor duplicado
    ...
    // gerar exepção  ao tentar adicionar um array duplicado

    @Test
    public void testAddDuplicateArray() {
        int[] elemArray = {2,3,4,2};
    ...
    // se criar um set a partir de uma array, se o array tiver valores suplicados, uma Exception será gerada
